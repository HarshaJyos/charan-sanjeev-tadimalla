    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-8 items-center">
        ...
        >
          ...
          {/* Layer 1: Deep purple foundation */}
          <motion.div
          ...
          {/* Layer 2: Large primary gradient blob */}
          <motion.div
          ...
          {/* Layer 3: Indigo accent from right */}
          <motion.div
          ...
          {/* Layer 5: Violet gradient from bottom */}
          <motion.div
