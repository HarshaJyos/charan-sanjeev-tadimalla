      ...
      <div className="container relative z-10">
        <div className="text-center flex flex-col items-center">
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <div className="w-16 h-16 rounded-3xl bg-teal/20 flex items-center justify-center text-teal shadow-2xl border border-teal/10">
              <Sparkles size={28} />
            </div>
          </motion.div>
          ...
          <motion.h2
            ...
            className="font-display text-4xl md:text-5xl lg:text-7xl text-white font-bold leading-[1.1] mb-12 tracking-tight"
          >
            Building the architecture of <br className="md:block" /> future-proof innovation.
          </motion.h2>

          <div className="w-12 h-[1px] bg-teal/40 mb-12" />
